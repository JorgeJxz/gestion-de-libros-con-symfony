 ...
 */
final class Version20210201212949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE libro ADD editorial_id INT DEFAULT NULL, DROP editorial');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE libro ADD editorial VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP editorial_id');
    }
}
